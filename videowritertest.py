...
# main_dir ='/home/pasan/Documents/PythonCode/Project/DAIN/MiddleBurySet/new_test/Temp/'
# dirFiles = os.listdir('/home/pasan/Documents/PythonCode/Project/DAIN/MiddleBurySet/new_test/Temp/') #list of directory files
...
video_path = '/media/pasan/New Volume/University of Manitoba/Winter/Final_Project/Video Files/fps60-480.mp4'
output_path = '/media/pasan/New Volume/University of Manitoba/Winter/Final_Project/Video Files/fps60-480-output.mp4'
...
while (i <= total_frames):    
    ...
    if i == total_frames:
        ...
        if ret1 == True:
            ...
            if ret2 == True:
                arguments_strFirst = frame1
                arguments_strSecond = frame2
                # Do the magic
                X0 =  torch.from_numpy( np.transpose(arguments_strFirst , (2,0,1)).astype("float32")/ 255.0).type(dtype)
                X1 =  torch.from_numpy( np.transpose(arguments_strSecond , (2,0,1)).astype("float32")/ 255.0).type(dtype)
                ...
                out.write(frame1)
                out.write(np.round(y_).astype(numpy.uint8))
                # out.write(frame2)
