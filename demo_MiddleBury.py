...
if DO_MiddleBurryOther:
    ...
    for dir in subdir:
        ...
        arguments_strFirst = os.path.join(MB_Other_DATA, dir, "hilux.jpeg")
        arguments_strSecond = os.path.join(MB_Other_DATA, dir, "test.jpeg")
        arguments_strOut = os.path.join(gen_dir, dir, "frame10i11.jpeg")
